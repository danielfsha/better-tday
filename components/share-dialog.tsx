...
export function ShareDialog({
  ...
  const [choice, setChoice] = useState<"public" | "private">(
    selectedVisibilityType,
  );
          ...
          {isPublic ? (
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border bg-card overflow-hidden">
                <button
                  ...
                  className={cn(
                    "w-full flex items-start gap-3 px-5 py-4 text-left hover:bg-muted/50",
                  )}
                >
                ...
                <button
                  ...
                  aria-disabled
                  className={cn(
                    "w-full flex items-start gap-3 px-5 py-4 text-left cursor-default",
                  )}
                >
                  <div className="mt-0.5">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[12px] text-muted-foreground">
                ...
                without permission, and see our
