...
export const PostMessageUpgradeDialog = React.memo(
  ({ open, onOpenChange }: PostMessageUpgradeDialogProps) => {
    ...
    const pricing = useMemo(() => {
      ...
      const usdFinalPrice: number =
        discountConfig.finalPrice || defaultUSDPrice;
      const hasUSDDiscount =
      ...
      const hasINRDiscount =
        !!discountConfig.inrPrice && discountConfig.inrPrice < defaultINRPrice;
    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent
          className="p-0 overflow-hidden gap-0 bg-background sm:max-w-[420px]"
                      ...
                      {pricing.inr.hasDiscount ? (
                        <>
                          <span className="text-sm text-white/60 line-through">
                            ₹{pricing.inr.originalPrice}
                          </span>
                          <span className="text-lg font-semibold">
                            ₹{pricing.inr.finalPrice}
                          </span>
                        </>
                      ) : (
                        <span className="text-lg font-semibold">
            ...
            <div className="space-y-3">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  ...
                  />
                  Explore Lookout
                  <span className="sm:ml-auto text-xs font-mono hidden sm:inline opacity-60">
                    ⌘ ⏎
                  </span>
                </Button>
                <Button
