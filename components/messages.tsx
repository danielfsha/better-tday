...
const Messages: React.FC<MessagesProps> = ({
  ...
  return (
    <div
      className="space-y-0 mb-38! sm:mb-42! flex flex-col"
      ...
      <div className="grow">
        {memoizedMessages.map((message, index) => {
          ...
          if (isCurrentMessageUser && isNextMessageAssistant) {
            ...
            messageClasses =
              "mb-8 pb-6 border-b border-border dark:border-border";
          } else if (
            isCurrentMessageAssistant &&
            index === memoizedMessages.length - 1
          ) {
            ...
            <div key={message.id || index} className={messageClasses}>
              <Message
                ...
                isMissingAssistantResponse={
                  index === missingAssistantResponseIndex
                }
                ...
                shouldReduceHeight={
                  message.role === "assistant"
                    ? isTransitioning ||
                      status === "submitted" ||
                      memoizedMessages[memoizedMessages.length - 1]?.role ===
                        "user"
                      ? true
                      : status === "streaming"
